...
public class CompletareRapoarteMediciView extends ViewGeneric{

	 public JTable tabel;
	 
	 public static DefaultTableModel modelTabel = new DefaultTableModel();
	 public JButton m_parafare = new JButton("Parafeaza raport");
	 ...
	 /** Constructor */
	 CompletareRapoarteMediciView(ModelGeneric model) {
        ...
        tabel.addKeyListener((KeyListener) new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    m_model.completareRaportMedici(id, resul, column);
        ...
        m_model.refreshTable();
	 	...
	 	content.add(panel1);
	 	content.add(m_parafare);
	 	
	        
	 	this.setContentPane(content);
	 	this.pack();

	 	this.setTitle("Rapoarte medici");
	 	this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	 }
	 
	 void addBtnParafare(ActionListener mal) {
		 m_parafare.addActionListener(mal);
	    }
