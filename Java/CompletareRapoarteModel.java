...
public class CompletareRapoarteModel extends ModelGeneric{

	CompletareRapoarteModel(){
	}
	
	
	public void refreshTable() {
		CompletareRapoarteView.modelTabel.setRowCount(0);
        ...
        String parafa = "";
		 ...
		 try {
			 	String queryStr = "SELECT * FROM rapoarte_programare WHERE (cnp_asistent = " + PoliclinicaMVC.CNP + " OR cnp_asistent IS NULL) ORDER BY cod_parafa;";
			    ...
			    while (rs.next()) {
			          ...
			          CompletareRapoarteView.modelTabel.addRow(new Object[]{id_raport, ziua, nume_pacient, prenume_pacient, rezultat,
	...
	public void completareRaport(String id, String result, int column) {
		int rezultat = -1;
		try {
			...
			cstmt.setString(3, CompletareRapoarteView.columnNames[column]);
			cstmt.setString(4, result);
			cstmt.registerOutParameter(5, java.sql.Types.INTEGER);
			
			System.out.println(CompletareRapoarteView.columnNames[column]);
